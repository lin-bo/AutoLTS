...
class Res50FC(nn.Module):
    ...
    def __init__(self, pretrained=False, frozen=False, out_dim=4):
        ...
        self.res50.fc = nn.Sequential(nn.Linear(dim, 100), nn.ReLU(), nn.Linear(100, out_dim))
...
class Res50FCFea(nn.Module):
    ...
    def __init__(self, pretrained=False, frozen=False, n_fea=1, out_dim=4):
